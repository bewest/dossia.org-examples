...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	/*Initialize API call */
	$api_service = "records/" . $dossia->record_id . "/documents/" . $document_id . "/meta";	//the particular api service
...
<html>
<head>
<title>Dossia Application Programming Interface - PHP Version</title>
</head>
<body>
	<table width="100%" cellpadding="10" cellspacing="0" border="0">
		<tr>
			...
			<td bgcolor="#00F0F0">
			<h2>Dossia Application Programming Interface - PHP Version</h2>
			Metadata</td>
		</tr>
		<tr>
			<td colspan="2" align="right"><a href="index.php">Return to Home</a></td>
		</tr>
	</table>
	<table width="500" cellpadding="0" align="center" cellspacing="0"
		border="0">
		<tr>
			<td bgcolor="#FDB98C"><?php
	...
	<br />
	<form name="getDossiaData" action="<?php echo $_SERVER['PHP_SELF'];?>"
		method="post"><input type="hidden" name="token"
		value="<?php echo $dossia->token;?>"> <input type="hidden"
		name="token_secret" value="<?php echo $dossia->token_secret;?>">
		<table width="100%" border="0" cellspacing="6" cellpadding="0">
			<tr>
				<td width="30%" align="right">Record ID:</td>
				<td width="70%"><input type="text" name="record_id" value="" size="50" />
				</td>
			</tr>
			<tr>
				<td width="30%" align="right">Document ID:</td>
				<td width="70%"><input type="text" name="doc_id" value="" size="50" />
				</td>
			</tr>
			<tr>
				<td width="30%" align="right">&nbsp;</td>
				<td width="70%"><input type="submit" name="call_api" value="Submit" />
				</td>
			</tr>
			<tr>
				<td align="right" valign="top">API Output:</td>
				<td><textarea cols="70" rows="12"><?php echo $api_output_data;?></textarea><br>
				</td>
			</tr>
		</table>
	</form>
