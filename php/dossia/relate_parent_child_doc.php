...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	$child_doc_id 	 = $_REQUEST['child_doc_id'];
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
			...
			Relating existing documents as parent and child documents </td>
        </tr>
			 ...
			 <tr>
				...
				<tr>
					   <td width="30%" align="right">
						...
						<td width="70%">
								<input type="text" name="parent_doc_id" value="" size="50"/>								 
						  </td>
				</tr>
				<tr>
					   <td width="30%" align="right">
						...
						<td width="70%">
								<input type="text" name="child_doc_id" value="" size="50"/>								 
						</td>
				</tr>
				<tr>
