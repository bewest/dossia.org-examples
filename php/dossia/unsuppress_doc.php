...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	if(isset($_REQUEST['doc_id']) && !empty($_REQUEST['doc_id'])){
		...
		/*Initialize API call */
		$api_service = 'records/'.$dossia->record_id.'/documents/'.$_REQUEST['doc_id'].'/unsuppress';
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td bgcolor="#00F0F0"><h2>Dossia Application Programming Interface - PHP Version</h2>UnSuppress a document.</td>
        </tr>
       ...
       <form enctype="multipart/form-data" name="getDossiaData" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
                	<td>&nbsp;</td>
                	<td><input type="submit" name="call_api" value="Submit"></td>
                </tr>
                <tr>
