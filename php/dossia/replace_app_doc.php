...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	if(isset($_FILES['userfile'])){
		...
		/*Initialize API call */
		$api_service = 'records/'.$dossia->record_id.'/apps/documents/key/'.$key.'/replace';
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td bgcolor="#00F0F0"><h2>Dossia Application Programming Interface - PHP Version</h2>Replacing an Application document with another document.</td>
        </tr>
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
                   <td width="30%" align="right">
                    ...
                    <td width="70%">
                            <input type="submit" name="call_api" value="Replace">
                      </td>
                </tr>
