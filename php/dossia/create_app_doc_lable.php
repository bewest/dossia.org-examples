...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	if(isset($_FILES['userfile'])) {
		...
		if(isset($_REQUEST['app_lable']) && !empty($_REQUEST['app_lable'])){
			$lable = $_REQUEST['app_lable'];
		}else{
			die("Invalid lable provided..");
		}
		/*Initialize API call */
		$api_service = "records/" . $dossia->record_id . "/apps/documents/key/$key/label/$lable"; 
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td bgcolor="#00F0F0"><h2>Dossia Application Programming Interface - PHP Version</h2> New Application Document with label </td>
        </tr>
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
                   <td width="30%" align="right">
                    ...
                    <td width="70%">
                            <input type="text" name="app_lable" value=""/>
                      </td>
                </tr>
                <tr>
                   <td width="30%" align="right">
