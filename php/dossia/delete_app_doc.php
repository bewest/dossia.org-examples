...
$dossia->service_path		= SERVICE_PATH;
$dossia->request_token_url	= REQUEST_TOKEN_URL;
$dossia->authorize_token_url= AUTHORIZE_TOKEN_URL;
$dossia->access_token_url	= ACCESS_TOKEN_URL;

/*Initialize the key and secret with Dossia supplied key and Dossia generated secret respectively.*/
$dossia->customer_key	 = CUSTOMER_KEY;
$dossia->customer_secret = CUSTOMER_SECRET;
...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	if(isset($_REQUEST['key']) && !empty($_REQUEST['key'])){
		...
		/*Initialize API call */
		$api_service = "records/".$dossia->record_id."/apps/documents/key/".$_REQUEST['key'];
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td bgcolor="#00F0F0"><h2>Dossia Application Programming Interface - PHP Version</h2> Application Document Deletion </td>
        </tr>
        ...
        <form name="getDossiaData" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        <textarea cols="70" rows="12"><?php echo $info["http_code"];?></textarea><br>
                    </td>
                </tr>
            </table>
        </form>
