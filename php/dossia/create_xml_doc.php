...
if(isset($_REQUEST['record_id']) && !empty($_REQUEST['record_id'])){
	...
	if(isset($_POST["api_input_data"]) && !empty($_POST["api_input_data"])) {
    ...
    <body>
       <table width="100%" cellpadding="10" cellspacing="0" border="0">
        <tr>
            ...
            <td bgcolor="#00F0F0"><h2>Dossia Application Programming Interface - PHP Version</h2> New XML Document</td>
        </tr>
        ...
        <form name="getDossiaData" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
            ...
            <table width="100%" border="0" cellspacing="6" cellpadding="0">
				...
				<tr>
	                    ...
	                    <td width="70%">
	                        <textarea name="api_input_data" cols="70" rows="12"><?= $_REQUEST['api_input_data']?></textarea>
	                    </td>
	            </tr>
	            <tr>
	                    <td>
