 ...
 */
   ...
   --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MetaData.aspx.cs" Inherits="MetaData" ValidateRequest="false" %>
        ...
        <tr>
          ...
          <tr>
            <td>
                ...
                <asp:TextBox ID="txtDocumentId" runat="server" Width="186px"></asp:TextBox><span style="color:Red">*</span>
            </td>
        </tr>    
        <tr>
                <td colspan="2">
