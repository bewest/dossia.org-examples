 ...
 */
   ...
   --%>
<%@ Page Language="C#" AutoEventWireup="true" validateRequest="false" CodeFile="CreateNewAppDocument.aspx.cs" Inherits="CreateNewAppDocument" %>
...
<body>
    ...
    <tr>
        <td>
            ...
            <asp:TextBox ID="txtRecordId" runat="server" Width="201px" ></asp:TextBox><span style="color:Red">*</span>
        </td>
    </tr>
    <tr>
        <td>
