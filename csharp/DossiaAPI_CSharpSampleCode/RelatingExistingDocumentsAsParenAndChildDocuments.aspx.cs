...
public partial class RelatingExistingDocumentsAsParenAndChildDocuments : System.Web.UI.Page
{
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        ...
        if (txtParentDocId.Text.Length == 0)
        {
            lblMessage.Text = "Please enter parent document id.";
            return;
        }
        if (txtChildDocId.Text.Length == 0)
        {
            lblMessage.Text = "Please enter child document id.";
            return;
        }
        ...
        string parentDocId = txtParentDocId.Text;
        string childDocId = txtChildDocId.Text;
        oAuth = new oAuthDossia();
        ...
        if (oAuth.Token.Length > 0 && oAuth.TokenSecret.Length > 0)
        {
            try
            {
                ...
                apiPostUrl = oAuthDossia.DOSSIA_API_URL + "records/" + recordId + "/documents/" + parentDocId + "/rels/related/" + childDocId;
                ...
                responseText = oAuth.MakePostRequest(accessTokenRedirectUrl);
