...
public partial class SpecificDocumentVersion : System.Web.UI.Page
{
    ...
    protected void btnRetrive_Click(object sender, EventArgs e)
    {
        ...
        //Authorize and use the token and secret and get the new access token
        ...
        if (oAuth.Token.Length > 0 && oAuth.TokenSecret.Length > 0)
        {
            try
            {
                ...
                apiGetUrl = oAuthDossia.DOSSIA_API_URL + "records/" + recordId + "/documents/" + documentId + "/versions/0";
