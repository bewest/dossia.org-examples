...
public partial class RetriveRecord : System.Web.UI.Page
{
    ...
    {       
        ...
        oAuth = new oAuthDossia();            
        //Authorize and use the token and secret in session to get the access token
        ...
        if (oAuth.Token.Length > 0 && oAuth.TokenSecret.Length > 0)
        {
            ...
            {                   
                ...
                apiGetUrl = oAuthDossia.DOSSIA_API_URL + "records/" + recordId;
