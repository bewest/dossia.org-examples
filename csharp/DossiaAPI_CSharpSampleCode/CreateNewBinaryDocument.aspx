 ...
 */
   ...
   --%>
<%@ Page Language="C#" AutoEventWireup="true" validateRequest=false CodeFile="CreateNewBinaryDocument.aspx.cs" Inherits="CreateNewBinaryDocument" %>
...
<body>
    ...
    <tr>
        <td colspan="2">
            <asp:TextBox ID="txtRecordId" runat="server" Width="208px"></asp:TextBox>
    ...
    <tr>
        ...
        <tr>
            <td style="color: maroon" colspan="2">
             <asp:TextBox ID="txtDossiaAPIInputRequest" runat="server" Columns="60" Rows="25" TextMode="MultiLine"></asp:TextBox></td>
        </tr>
    <tr>
        <td>Upload file</td>
        <td> 
