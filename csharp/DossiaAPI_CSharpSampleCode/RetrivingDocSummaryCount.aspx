 ...
 */
   ...
   --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetrivingDocSummaryCount.aspx.cs" Inherits="RetrivingDocSummaryCount" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Retrieving Document Summary Counts</title>
</head>
<body>
    ...
    <table>
            ...
            <tr>
                ...
                <label>Record Id</label></td><td>
                    <asp:TextBox ID="txtRecordId" runat="server" Width="219px"></asp:TextBox> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
