 ...
 */
   ...
   --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RetriveDocumentWithinRecord.aspx.cs" Inherits="RetriveDocumentWithinRecord" ValidateRequest="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Retrieving Root Level Documents Within a Record</title>
</head>
<body>
    ...
    <table>
            ...
            <tr>
                ...
                <label>Record Id</label></td><td>
                    <asp:TextBox ID="txtRecordId" runat="server" Width="218px"></asp:TextBox> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
