...
public partial class ReplaceAppDocWithAnotherDoc : System.Web.UI.Page
{
    ...
    protected void btnPost_Click(object sender, EventArgs e)
    {
        ...
        if (oAuth.Token.Length > 0 && oAuth.TokenSecret.Length > 0)
        {
            try
            {
                ...
                apiPostUrl = oAuthDossia.DOSSIA_API_URL + "records/" + recordId + "/apps/documents/key/" + keyId + "/replace";
