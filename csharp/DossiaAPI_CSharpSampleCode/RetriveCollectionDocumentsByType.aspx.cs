...
public partial class RetriveCollectionDocumentsByType : System.Web.UI.Page
{
    ...
    protected void btnRetrive_Click(object sender, EventArgs e)
    {
        ...
        if (oAuth.Token.Length > 0 && oAuth.TokenSecret.Length > 0)
        {
            ...
            {   
                ...
                apiGetUrl = oAuthDossia.DOSSIA_API_URL + "records/" + recordId + "/documents/document_type/"+ ddlDocumentType.SelectedItem.Text;
