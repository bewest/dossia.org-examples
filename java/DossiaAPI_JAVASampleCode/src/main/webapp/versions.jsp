...
<html><head><title>Versions</title></head><body>
	...
	<form method="POST" action="./versions.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_DOCUMENT_VERSIONS%>"/>
