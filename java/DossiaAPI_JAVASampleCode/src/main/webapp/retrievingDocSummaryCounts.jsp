...
<html><head><title>Retrieving Document Summary Counts</title></head><body>
	
	<form method="POST" action="./retrievingDocSummaryCounts.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_SUMMARY_COUNT%>"/>
