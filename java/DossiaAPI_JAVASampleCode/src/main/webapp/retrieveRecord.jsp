...
<html><head><title>Retrieving a Record</title></head><body>
	
	<form method="POST" action="./retrieveRecord.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_RETRIEVE_RECORD%>"/>
