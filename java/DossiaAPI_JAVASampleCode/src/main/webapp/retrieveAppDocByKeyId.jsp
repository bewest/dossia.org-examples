...
<html><head><title>Retrieving a Application document by Key id</title></head><body>
	
	<form method="POST" action="./retrieveAppDocByKeyId.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_RETRIEVE_APP_DOCUMENT%>"/>
