...
<html><head><title>Retrieving a Binary Document</title></head><body>
	
	<form method="POST" action="./retrievingBinDoc.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_RETRIEVE_BIN_DOCUMENT%>"/>
		...
		<br>Binary Document ID: <input type="text" name="documentId"/>
