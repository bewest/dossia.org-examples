...
<html><head><title>Metadata for Application documents</title></head><body>
	
	<form method="POST" action="./retrieveAppDocMetadata.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_APP_DOCS_METADATA%>"/>
