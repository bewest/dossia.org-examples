...
<html><head><title>Retrieving Root Level Documents Within a Record</title></head><body>
	
	<form method="POST" action="./retrievingRootLevelDocInRecord.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_ROOT_LEVEL_DOCUMENTS%>"/>
