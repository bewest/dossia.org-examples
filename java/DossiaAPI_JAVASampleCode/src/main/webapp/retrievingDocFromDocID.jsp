...
<html><head><title>Retrieving a Document From a Document ID</title></head><body>
	...
	<form method="POST" action="./retrievingDocFromDocID.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_RETRIEVE_DOCUMENT%>"/>
