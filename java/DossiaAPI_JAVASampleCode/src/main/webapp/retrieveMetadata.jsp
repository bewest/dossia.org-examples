...
<html><head><title>Metadata</title></head><body>
	
	<form method="POST" action="./retrieveMetadata.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_DOCUMENT_METADATA%>"/>
