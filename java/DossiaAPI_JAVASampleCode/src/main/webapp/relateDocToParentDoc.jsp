...
<html><head><title>Relating a Document to a Parent Document</title></head><body>
	...
	<form method="POST" action="./relateDocToParentDoc.jsp">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_RELATE_DOCUMENT%>"/>
