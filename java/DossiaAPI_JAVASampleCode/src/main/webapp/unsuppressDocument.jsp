...
<html><head><title>Delete Application Document</title></head><body>
	...
	<form method="POST" action="./unsuppressDocument.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_UNSUPPRESS_DOCUMENT%>"/>
		...
		<br><input type="submit" name="submit" value="Unsuppress"/>
	</form>
