...
<html><head><title>Create Binary Document</title></head><body>
	
	<form method="POST" action="./createBinDocument.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_CREATE_DOCUMENT%>"/>
		...
		<br>Upload Binary Document: <input type="file" name="binFile">
