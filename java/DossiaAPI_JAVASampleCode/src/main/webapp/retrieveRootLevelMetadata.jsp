...
<html><head><title>Metadata of Root level documents</title></head><body>
	
	<form method="POST" action="./retrieveRootLevelMetadata.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_ALL_DOCUMENT_METADATA%>"/>
