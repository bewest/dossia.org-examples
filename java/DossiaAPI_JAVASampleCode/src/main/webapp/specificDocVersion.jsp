...
<html><head><title>Specific Document Version</title></head><body>
	
	<form method="POST" action="./specificDocVersion.jsp" enctype="multipart/form-data">
		<input type="hidden" name="<%=DossiaOAuthClient.PARAM_API_CALL%>" value="<%=DossiaOAuthClient.DOSSIA_API_CALL_SPECIFIC_VERSION%>"/>
